...
$passwordLength = strlen($password);
	...
	if ($username == "") {
		...
		if ($isExist > 0) {
			...
			//Insert new user
			$sqlIn = "INSERT INTO users(UID, userName, pssword, dateJoined, isAdmin, isBanned, billingAddress,interest)
					values ('$nextId', '$_POST[usernameInput]', '$_POST[passwordInput]', '$date', false, false, '$_POST[billingAddressInput]','$_POST[interestInput]')";
...
<div class="w3-card-4">
  ...
  <form class="w3-container" action="register.php" method="POST">
    ...
    <p>
	<p>      
    <label class="w3-text-brown"><b>Interest</b></label>
    <input class="w3-input w3-border w3-sand" name="interestInput" type="text"></p>
	<p> 
